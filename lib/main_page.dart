...
class _SubtitleTranslatorPageState extends State<SubtitleTranslatorPage> {
  ...
  ProcessingMode _mode = ProcessingMode.singleFile;
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Row(
                children: [
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Icon(Icons.file_open_outlined, size: 40, color: Colors.blueAccent,),
                        const Text('Passo 1', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold),),
                        const SizedBox(height: 10),
                        
                      RadioGroup<ProcessingMode>(
                        groupValue:_mode,
                        ...
                        child: Column(
                          children: [
                            ListTile(
                              title: const Text('Processar um único arquivo de vídeo'),
                              leading: Radio<ProcessingMode>(value: ProcessingMode.singleFile),
                            ),
                            ListTile(
                              title: const Text('Processar vários arquivos de vídeo'),
                              leading: Radio<ProcessingMode>(value: ProcessingMode.folder),
                            ),
                          ],
                        ),
                      ),
                ...
                label: const Text('Confirmarar Vídeo e Extrair Legendas'),
